  ...
  return (
    <div className=' bg-teal-50 relative flex justify-center text-center px-10 py-10'>
        <form onSubmit={handleSubmit}>
            <h2 className='text-center text-4xl font-bold text-teal-800'>Student login</h2>
            ...
            <Link to='/forgot' className='block text-xl text-white'>Forgot password</Link>

            <button type='submit' className='border-2 rounded-2xl bg-white px-5 py-3 text-xl '>login</button></div>
           <p>Dont have an account?? <Link to='/student/register' >Register</Link></p>
        </form>
    </div>
  )
}
