...
const WardenRegister = () => {
    ...
    const handleSubmit= async (e) =>{
      ...
      try{
        ...
        const res = await fetch('https://hostelaid.onrender.com//api/auth/warden/register', {
          method:'POST',
  ...
  return (
    <div className=' bg-teal-50 relative flex justify-center text-center px-10 py-10'>
        <form onSubmit={handleSubmit}>
            <h2 className='text-center text-4xl font-bold text-teal-800'>warden Register</h2>
           ...
           <p>Have an account?? <Link to='/warden/login' >Login</Link></p>
        </form>
    </div>
  )
}
